...
public class SurveyServiceImpl implements SurveyService {
    ...
    public Page<Survey> getHistorySurveyWithPagination(String term, int pageNum) {
        PageRequest pageRequest = PageRequest.of(pageNum, PAGEMAXSIZE);
        Set<Answer> answerList = answerRep.findAllByAccountId(getUserContext().getAccountId());
        return surveyRep.findAllByAnswersAndIsDeleted(answerList, false, term, pageRequest);
    }
